---
title: >-
  The Bug That Wasn't a Bug Yet: Hunting a Dormant API Contract Violation in
  Meshery
subtitle: >-
  How reading a naming-convention doc closely enough led to a 20-site fix for a
  pagination bug in a CNCF project that hadn't broken anything, yet.
minRead: 9 min read
date: 'Aug 24, 2026'
heroImage: /images/journal-face-film.png
heroImageAlt: >-
  Close-up of a freckled woman behind a translucent film strip—soft, dewy skin,
  minimal beauty editorial on white.
intro: >-
  How reading a naming-convention doc closely enough led to a 20-site fix for a
  pagination bug in a CNCF project that hadn't broken anything, yet.
author:
