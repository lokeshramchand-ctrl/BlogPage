...
subtitle: >-
  An architectural deep dive into how Velar builds a privacy-first, grounded RAG
  pipeline using Milvus, Ollama, and FastAPI without relying on external LLM
  APIs.
minRead: 7 min read
date: 'Aug 7, 2026'
heroImage: /images/journal-tote-bag.png
heroImageAlt: >-
  Minimal beige canvas tote bag with sturdy handles and a small leather tag on a
